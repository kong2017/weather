$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "Currently: " + data.currently.summary + " / Tomorrow: " + data.daily.data[0].summary + " / Day After Tomorrow: " + data.daily.data[1].summary + "/ In 3 Days: " + data.daily.data[2].summary;
